...
final class Better_Banners_Admin
{
    ...
    private function enqueue_styles(): void
    {
        ...
        if (self::is_current_page_banner_post_page()) {
            ...
            wp_enqueue_style(
                ...
                plugin_dir_url(__FILE__) . '../assets/css/post.css'
            );
        }
        ...
        if (self::is_current_page_banner_table_page()) {
            wp_enqueue_style(
                ...
                plugin_dir_url(__FILE__) . '../assets/css/table.css'
            );
        }
    }
    ...
    {
        return plugin_dir_url(__FILE__) . '../assets/svg/better-banners-logo.svg';
    }
}
